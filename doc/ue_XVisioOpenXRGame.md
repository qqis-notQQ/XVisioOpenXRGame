...
从 Epic Games Fab 安装适用于您引擎的 XVisio OpenXR 插件 ，然后打开一个现有项目或创建一个新项目。或者，您也可以手动下载并安装该插件。

为了充分利用所有功能和性能优化，我们建议您在为 XVisio 头显开发应用时始终使用 XVisio OpenXR 插件。您也可以在 Unreal 中启用 OpenXR，而无需使用 XVisio 特有的功能。

在插件中，搜索XR并激活XVisioOpenXR、OpenXR、OpenXREyeTracker、OpenXRHandTracking。
...
请参阅推荐设置，了解支持的渲染功能以及如何优化视觉质量和性能的说明。
...
建议使用 XVisio OpenXR 插件以访问所有支持的功能。XVisio OpenXR 插件会自动启用内置的 OpenXR 插件。如果您只想使用 OpenXR 而不想使用 XVisio 特有的功能，可以按照以下步骤启用 OpenXR。

在 Unreal 中启用 OpenXR，而无需 XVisio 特有的功能
...
继续按照Unreal 入门指南中的步骤操作。

## 使用虚幻引擎5实现混合现实

使用 XVisio OpenXR 插件，您可以快速轻松地为 XVisio XR 头显开发混合现实应用程序。请按照以下说明开始操作。

安装好 XVisio OpenXR 插件后（请参阅 Unreal 入门指南），请按照以下说明在您的项目中启用混合现实。

从Actor父类创建一个名为BP_MRControls的新蓝图类。

<figure class="half">
    <img src="./image-35.png" height="500">
    <img src="./image-36.png" height="500">
</figure>
...
<figure class="half">
    <img src="./image-41.png" height="300">
    <img src="./image-42.png" height="300">
</figure>
...
![alt text](7c552fc2-1e65-4445-ad7d-a15774e01885.png)
